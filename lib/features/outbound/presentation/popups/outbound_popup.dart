...
class _OutboundPopupState extends ConsumerState<OutboundPopup> {
  ...
  void initState() {
    ...
    _doNoListener = () {
      if (ref.read(outboundPopupVMProvider).doNo != _doNoController.text) {
        ref
    ...
    _savedBinNoListener = () {
      if (ref.read(outboundPopupVMProvider).savedBinNo !=
  ...
  Widget build(BuildContext context) {
    ref.listen<OutboundPopupState>(outboundPopupVMProvider, (previous, next) {
    ...
    final isLoading = ref.watch(
      outboundPopupVMProvider.select((s) => s.isLoading),
    );
