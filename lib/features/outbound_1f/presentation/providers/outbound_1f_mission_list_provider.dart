...
class Outbound1FMissionListState extends Equatable {
  final List<Outbound1fSmEntity> missions;
  ...
  Outbound1FMissionListState copyWith({
    List<Outbound1fSmEntity>? missions,
...
class Outbound1FMissionListNotifier
  ...
  void listenToMissions() {
    ...
    _missionSubscription = _outbound1FMissionRepository.outbound1fMissionStream
        .listen(
          (missions) {
...
final outbound1FMissionListProvider =
    StateNotifierProvider<
      Outbound1FMissionListNotifier,
      Outbound1FMissionListState
    >((ref) {
      // ✨ 변경: outbound1FMissionRepositoryProvider watch
      final outbound1FMissionRepository = ref.watch(
        outbound1fMissionRepositoryProvider,
      );
